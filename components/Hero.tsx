      ...
      <header className="flex items-center justify-between px-8 py-4 bg-white">
        ...
        <div className="flex items-center z-[50] space-x-4">
          <Link href="/sign-up/banks">
            <button className="px-4 py-3 hidden md:block text-sm font-bold text-white bg-green-500 rounded-full hover:bg-green-600">
              Register
            </button>
          </Link>
          <Link href="/sign-in">
            <button className="px-4   py-2 border border-green-400 text-green-400 font-bold rounded-full hover:bg-pink-50">
              Sign In
            </button>
          </Link>
        </div>
      ...
      <main className="flex flex-col max-sm:flex-col-reverse sm:flex-col-reverse lg:flex-row  py-12">
        <div className="w-full md:w-1/2  pr-10" data-aos="fade-up">
          ...
          <div className="flex space-x-4 px-5 mb-8">
            <Link href="/sign-in">
              <button className="md:px-6 px-4 text-sm py-4 bg-green-500 text-white font-bold rounded-full hover:bg-green-600">
                APPLY ONLINE
              </button>
            </Link>

            <Link href="/sign-up/banks">
              <button className="md:px-6 px-3 py-3 border border-green-500 text-green-500 font-bold rounded-full hover:bg-pink-50">
                GET STARTED
              </button>
            </Link>
          </div>
